...
import modules.AutopilotDevelopment.Plane.Operations.system_state as plane_system_state
...
class Plane:
    ...
    def start_payload_drop_mission(self):
        mission.upload_payload_drop_mission(self.vehicle_connection)
