...
def reposition(vehicle_connection, ground_speed, loiter_radius, loiter_direction, latitude, 
                  longitude, altitude):
    vehicle_connection.mav.send(vehicle_connection.mav.command_long_send( # Specify COMMAND_LONG
        ...
        ground_speed, 
        mavutil.mavlink.MAV_DO_REPOSITION_FLAGS, # Param 2 - Flight mode number
        loiter_radius, 
        loiter_direction,
        latitude, 
        loiter_direction, 
