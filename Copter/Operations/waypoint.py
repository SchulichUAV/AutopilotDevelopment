...
def waypoint_progress(vehicle_connection):
    ...
    try:
        ...
        print(f"Error in function: waypoint_progress() from file: Copter/Operations/waypoint.py -> {e}")
...
def relative_movement(vehicle_connection, x, y, z):
    ...
    try:
        ...
        print(f"Error in function: relative_movement() from file: Copter/Operations/waypoint.py -> {e}")
...
def absolute_movement(vehicle_connection, latitude, longitude, altitude):
    ...
    try:
        ...
        print(f"Error in function: absolute_movement() from file: Copter/Operations/waypoint.py -> {e}")
    # waypoint_progress(vehicle_connection) # Comment out if you want to see live updates in Mission Planner
